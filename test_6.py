...
class Test6:
    ...
    def test_try_withdraw_value_on_account(self, open_login_page):
        ...
        # Clica na aba de débito e tenta debitar um valor aleatório, sem ter depositado nenhum valor anterior
        ...
        account_page.withdraw_randoms_values()
        assert account_page.withdraw_uncompleted(), "Débito realizado!"
