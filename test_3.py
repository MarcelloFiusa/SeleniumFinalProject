...
class Test3:
    ...
    def test_click_to_search_customer(self, open_login_page):
        ...
        # Pesquisa pelo usuário registrado anteriormente para certificar seu registro no banco de dados
        search_customer_page = SearchCustomerPage(driver=open_account_page.driver)
        ...
        assert search_customer_page.is_first_name_listed(), "Nome não registrado"
